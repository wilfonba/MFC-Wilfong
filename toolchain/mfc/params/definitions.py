...
def _load():
    ...
    for i in range(1, NP + 1):
        ...
        # 2D modal (geometry 13): Fourier modes and options (keep in sync with max_2d_fourier_modes)
        for j in range(1, 33):
        ...
        # 3D spherical harmonic (geometry 14): coeffs (l, m), l=0..max_sph_harm_degree, m=-l..l
        for ll in range(0, 11):
