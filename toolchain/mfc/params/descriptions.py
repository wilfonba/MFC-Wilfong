...
DESCRIPTIONS = {
    ...
    "jfnk_max_newton": "Maximum Newton iterations per time step",
    "jfnk_krylov_dim": "GMRES restart dimension (Krylov vectors held in memory)",
    "jfnk_max_restarts": "Maximum GMRES restarts per Newton step",
    ...
    "proj_single_solve": "Solve the projection pressure system only at the final RK stage; intermediate stages advance advectively with the stage-start pressure frozen (default F)",
    ...
    "proj_cfl_ac": "Maximum acoustic CFL cap for projection time step (<= 0 disables)",
