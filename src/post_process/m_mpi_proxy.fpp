...
contains
    ...
    subroutine s_initialize_mpi_proxy_module
        ...
        if (buff_size > 0) then
            ...
            allocate(q_cons_buffer_out(0:ubound(q_cons_buffer_in, 1)))
    ...
    subroutine s_mpi_bcast_user_inputs
        ...
        #:for VAR in [ 'cyl_coord', 'mpp_lim', 'mixture_err',                  &
            ...
            & 'adv_n', 'ib', 'cfl_adap_dt', 'cfl_const_dt', 'cfl_dt', 'down_sample','igr',          &
        ...
        #:for VAR in [ 'pref', 'rhoref', 'R0ref', 'poly_sigma', 'Web', 'Ca', &
            ...
            & 'y_output%end', 'z_output%beg', 'z_output%end' ,'x_domain%beg', 'x_domain%end', &
            & 'y_domain%beg', 'y_domain%end', 'z_domain%beg', 'z_domain%end']
