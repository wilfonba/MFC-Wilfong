...
contains
    ...
    function f_simplex3d(xin, yin, zin) result(n)
        ...
        gi0 = mod(p(ii + p(jj + p(kk) + 1) + 1), 12) + 1
        gi1 = mod(p(ii + i1 + p(jj + j1 + p(kk + k1) + 1) + 1), 12) + 1
        gi2 = mod(p(ii + i2 + p(jj + j2 + p(kk + k2) + 1) + 1), 12) + 1
        gi3 = mod(p(ii + 1 + p(jj + 1 + p(kk + 1) + 1) + 1), 12) + 1
    ...
    function f_simplex2d(xin, yin) result(n)
        ...
        gi0 = mod(p(ii + p(jj)), 12) + 1
        gi1 = mod(p(ii + i1 + p(jj + j1)), 12) + 1
        gi2 = mod(p(ii + 1 + p(jj + 1)), 12) + 1
