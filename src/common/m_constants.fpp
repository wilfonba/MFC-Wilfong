...
module m_constants
    ...
    integer, parameter  :: max_2d_fourier_modes = 32           !< Max Fourier mode index for 2D modal patch (geometry 13)
    integer, parameter  :: max_sph_harm_degree = 10            !< Max degree L for 3D spherical harmonic patch (geometry 14)
